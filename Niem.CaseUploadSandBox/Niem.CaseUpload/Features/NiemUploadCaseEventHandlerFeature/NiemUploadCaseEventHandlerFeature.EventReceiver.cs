...
namespace Niem.CaseUploadSandBox.Features.Niem_UploadCase_EventHandler_Feature
{
    /// <summary>
...
/*
        ...
        public void AddNiemUploadEventReceiver(SPWeb sysWeb, string spListTitle)
        {
            ...
            if (spListCustom != null)
            {
                ...
                string assemblyName = "Niem.CaseUploadSandBox, Version=1.0.0.0, Culture=neutral, PublicKeyToken=6f7c7006f477a0a5";
                string className = "Niem.CaseUploadSandBox.NiemUploadCaseHandler.NiemUploadCaseEventHandler";
