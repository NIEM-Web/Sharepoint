...
namespace NIEM.Map.ProjectInfoEventHandler.EventHandlers
{

    public class NIEMProjectInfoEventHandler : SPItemEventReceiver
    {
        public override void ItemAdded(SPItemEventProperties properties)
        {
            ...
            try
            {
                if (properties.ListTitle == "NIEM Project Info")
                {
                        ...
                        using (SPSite site = new SPSite(siteID))
                        {
                            using (SPWeb web = site.OpenWeb(webID))
                            {
                                ...
                                if (item != null)
                                {
                                    ...
                                    StartWorkflow(item, "NIEM_Project_Info_Approval_Initiation", properties.SiteId);
            ...
            {
                Common.LogError("NiemProjectInfoEventHandlerEventReceiver.ItemAdded", ex, properties.SiteId);
            }
        }
