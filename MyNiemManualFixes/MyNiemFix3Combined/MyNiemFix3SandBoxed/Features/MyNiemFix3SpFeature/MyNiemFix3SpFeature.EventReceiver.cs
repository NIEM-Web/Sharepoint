...
namespace MyNiemFix3SandBoxed.Features.MyNiemFix3SpFeature
{
    /// <summary>
    ...
    [Guid("071b7160-4bbc-43a0-a6c2-0b491992806f")]
    public class MyNiemFix3SpFeatureEventReceiver : SPFeatureReceiver
    {
