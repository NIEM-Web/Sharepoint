$( document ).ready( function() {
	...
	if ( $caseStudy.is(":checked") && $.trim( $caseStudyId.val() ) === "" ) {
		$helpWithStudy
			.closest("tr")
				.hide();
...
function openDisplayForm() {
	OpenModalForm({
		...
		//L_Menu_BaseUrl: 'https://www.niem.gov/documentsdb',
		url: "/_layouts/Upload.aspx?List={42F6D402-900C-4979-B523-EEC61123061B}&RootFolder=",
		autoSize: true,
...
function PreSaveAction() {
	...
	//Fix this b/c save can be pressed and then this is renabled.
	$country[0].disabled = false;

	//Lookup lat/long if US Address.
	if ( intlAddress ) {
