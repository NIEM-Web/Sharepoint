...
namespace lmd.NIEM.FarmSolution.NiemUserProfileWebPart
{

    public delegate void _OnProfileChange(string fname, string lname, string email, string org, long recordID);

    [ToolboxItemAttribute(false)]
    public class NiemUserProfileWebPart : WebPart
    {
        ...
        private const string _ascxPath = @"~/_CONTROLTEMPLATES/lmd.NIEM.FarmSolution/ctrlUserProfile.ascx";
        /// <summary>
