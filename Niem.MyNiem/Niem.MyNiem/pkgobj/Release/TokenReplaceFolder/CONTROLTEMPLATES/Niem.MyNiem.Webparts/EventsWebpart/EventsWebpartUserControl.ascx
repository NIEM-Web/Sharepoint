...
<tr style="margin-top:6px;">
<td>Search: </td>
<td><div><asp:TextBox ID="txtSearch" Width="125px" runat="server" /></div></td>
...
<td style="width: 624px">
 ...
 <asp:Literal ID="lcArticleDate" Text='<%#Eval("EventDate") %>' runat="server" />-<asp:Literal ID="lcCommittees" Text='<%#Eval("Category_x0020_Committee") %>' runat="server" />
 <div>
	<asp:Literal ID="lcComments" Text='<%#Eval("Comments") %>' runat="server" />&nbsp;<strong><a href="#" onclick="<%# "DisplayItem('" +Eval("LinkField")+"','"+Eval("Title")+ "');" %>">Read More...</a></strong><br/>
</div>
</td>
<td>
